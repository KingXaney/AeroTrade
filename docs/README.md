...
| [Quant strategies](specs/2026-09-21-quant-strategies.md) | Eight classic quant strategies paper-traded live by deterministic rules with a simulated warm-up: engine, catalog, daily job, Yahoo-first price bars, /strategies pages and widget | Implemented — `feat/quant-strategies` |
